...
{
    [Binding]
    public class Ex10_PaymentPageStepDefinitions
    {
        IWebDriver driver;
        string url = "https://demo.nopcommerce.com/";

        // 1. Valiadte User is able to complete Payment process Successfully
        ...
        public void ThenUserIsNavigatedToCheckoutPageSuccessfully_()
        {
        ...
        {
            IWebElement continue4 = driver.FindElement(By.XPath("(//button[@name='save'])[2]"));
            continue4.Click();
        ...
        //Validate User is able to Complete The Payment Proceess with Money Order Feature 

        [When(@"Clicks on Continue of the Payment Info\.\.")]
        public void WhenClicksOnContinueOfthePaymentInfo_()
        {
            IWebElement continue5 = driver.FindElement(By.XPath("//button[@class='button-1 payment-method-next-step-button']"));
            continue5.Click();           
            Thread.Sleep(1000);
            IWebElement continue6 = driver.FindElement(By.XPath("//button[@class='button-1 payment-info-next-step-button']"));
            continue6.Click();
            Thread.Sleep(1000);
        }
        ...
        public void ThenOrderIsSuccessfullyProcessedWithMoneyOrderFeature()
        {
            IWebElement confirmMessage = driver.FindElement(By.XPath("//*[text()='Your order has been successfully processed!']"));
            string expextedMessage = "Your order has been successfully processed!";
            string actualMessage = confirmMessage.Text;
